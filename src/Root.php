...
class Root {
     ...
     *
     * @var \Illuminate\Database\Eloquent\Collection|\Datlv\Category\Category[]
     */
    protected $roots;
    /**
     * @var int
     ...
     *
     * @param \Datlv\Category\Category|mixed|null $selected
     * @param int $max_depth
     *
     * @return string
     */
    ...
    /**
     * @return \Illuminate\Database\Eloquent\Collection|\Datlv\Category\Category[]
     */
